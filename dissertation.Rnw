...
vigilence towards negative words, and words associated with the current
...
a novel test of the potential for ABM training to offer a personlised,
cost-effective treatment for anxiety and depression. Given the various
conceptualizations of rumination, \textcite{smith_roadmap_2009} recommend
using multiple outcome measures. The difficulties in distinguising
rumination from worry, and the common comorbidity of anxiety and

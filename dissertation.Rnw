...
as a subtype of past-focussed rumination} worry or both.

Reduced attentional bias, state rumination, state anxiety and depression
...
\caption{GRS scores (participants 5--10). A = Phase A (dot-probe
...
\caption{PA scores (participants 5--10). A = Phase A (dot-probe
baseline), B = Phase B (ABM training followed by dot-probe). Dotted
...
\caption{NA scores (participants 5--10). A = Phase A (dot-probe
baseline), B = Phase B (ABM training followed by dot-probe). Dotted
...
\caption{Depression ('sad'+'depressed') scores (participants 5--10). A
= Phase A (dot-probe baseline), B = Phase B (ABM training followed by

...
\todo{numbers, age, gender}

Participants were recruited at the University of Exeter, using the
school of Psychology research participation system, on-campus posters,
email and Facebook. People were invited to evaluate a computer-based
task with the potential to reduce rumination towards an unresolved
problem of their own choosing.  A maximum payment of {\pounds}20 was
offered to participants who completed all 35 sessions. Participants had
to be fluent in English, have normal, or corrected to normal vision,
have access to a home computer running Windows, Macintosh (OS X 10.9
or later), or Linux operating systems, and not concurrently undergoing
psychotherapy or taking psychotropic medication.
...
score ${\geq}$ 55. The RRS and PSWQ cutpoints were calculated to place
...
\parencite{spitzerrl_brief_2006}. Scales related to the previous 4
...
\begin{itemize}
\item {
Last month, tense modified where necessary}
\end{itemize}
\end{itemize}
\item {
State}
...
\begin{itemize}
\item {
Last 24 hours, tense modified where necessary}
\end{itemize}
\end{itemize}
\item {
Post treatment}
...
\subsubsection{SAWL}
{
\textbf{\textit{How are affective word ratings related to lexicosemantic properties? Evidence from the Sussex Affective
Word List }}\textbf{\textit{(Citron, Weekes, \& Ferstl, 2014)}}}
...
Ps did the final survey within 12 hours of the final session.
...
Fifteen participants (12 female) meeting the screening criteria completed the setup session (see Table n).
...
\todo{Limitation: longevity of effects treatment?}
...
\tabletail{}
\tablelasttail{}
\begin{supertabular}{m{2.102cm}m{14.511001cm}}
\hline
{ Pair number} &

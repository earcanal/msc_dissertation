...
PHQ-8 score of \Sexpr{sprintf("%0.1f",mean(screening$phq8total))}
...
power (1-$\beta$) gave \Sexpr{rrs_pwr} for RRS, \Sexpr{bdi_pwr} for BDI-II
and \Sexpr{stai_pwr} for STAI-T. \textcite{yang_attention_2015} did not
...
power (1-$\beta$) of \Sexpr{pswq_pwr}. Although the study used

...
24 hours (except where sessions postponed). Attentional bias was
...
added 4 items to the PANAS-SF.  Items 'sad' and 'depressed' were added
as a state measure of depression, with the rationale that they would
correlate negatively with PA and positively with NA.  Items 'anxious'
and 'worried' were added as state measures of worry \todo{I need to have
...
Secondary measures were taken before and after the dot-probe/ABM sessions.
Trait rumination was measured using the Ruminative Responses Scale
(RRS), which is reliable and valid, having an expected Cronbach's
$\alpha$ of .85 \parencite{treynor_rumination_2003}. Trait anxiety was
measured using the 7 item Generalised Anxiety Disorder (GAD-7) scale,
an efficient, valid (Cronbach's $\alpha$ > .85), tool for assessing
GAD severity in clinical research, with good test-retest reliability

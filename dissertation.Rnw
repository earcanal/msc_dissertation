...
\usepackage{tabularx}
\usepackage{tikz}
\newcommand\strokeA{\tikz[baseline=-.5ex]{ \draw[black,align=center] (0,0) -- (2ex,0); }}
\newcommand\strokeB{\tikz[baseline=-.5ex]{ \draw[red,dotted] (0,0) -- (2ex,0); }}
\newcommand\strokeC{\tikz[baseline=-.5ex]{ \draw[black,dotted] (0,0) -- (2ex,0); }}
\begin{document}
...
phases) \parencite{morley_graphical_1991}. In the following graphs,
the broadened median is used as a measure of central tendency as it is
...
Changes in attentional bias for I-word pairs are summarised in \cref{fig:va-i1} and \cref{fig:va-i2}.

Describe synthesis across Ps (patterns), but possibly draw attention to outliers.

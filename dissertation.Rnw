...
with depression and anxiety. Attention is one of a number of cognitive
process which, when biased, are associated with these emotional
disorders. Goal progress theory suggests that rumination occurs when
there are discrepancies in progress towards a goal. Depressive rumination
has also been hypothesised as resulting from an impaired ability to
disengage attention from negative thoughts. To test this theory and
hypothesis, the current study measures the effects of attentional bias
modification (ABM) towards negative words, and words associated with a
current concern. Participants were 12 (10 female) university students
of staff scoring low for depression but high for trait rumination
...
critique is based on meta-analyses which don't differentiate ABM from
other forms of CBM, which don't focus on a single psychological dysfunction
...
randomisation schedule\footnote{Randomisation schedules were
...
to ruminate. This effect was qualified- ified by a marginally significant

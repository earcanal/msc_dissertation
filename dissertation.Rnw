...
A case series design was chosen as this is a small-scale,
proof-of-principle study with limited funds for recruiting participant
numbers required for a group study. More specifically, this was
...
the research participation system in the school of Psychology, on-campus posters, email
...
completed all 35 sessions.  Inclusion criteria were no concurrent
psychotherapy or psychotropic medication and a PHQ-8 score {\textless}
10 \parencite{kroenke_phq8_2009}.  To ensure enough participants are
recruited, a liberal inclusion criterion of Ruminative Responses Scale
(RRS) ${\geq}$ 50 \parencite{treynor_rumination_2003} or Penn State Worry
Questionnaire (PSWQ) ${\geq}$ was used. Initial recruitment responses were low,
so ... are high then this threshold may
...
\begin{itemize}
\item {
PHQ-8 {\textless} 11, RRS {\textgreater}= 53, PSWQ {\textgreater}= 55}
\end{itemize}
\item {
Baseline}

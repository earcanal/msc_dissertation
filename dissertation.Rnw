...
The Attentional Bias Modification (ABM) task was based on the dot-probe
task, but differed in three respects. First, there were double the
number (192) trials in each block. Second, only N-word pairs were used
as stimuli. Finally, probes in ABM trials always appeared at the neutral
word location. Thus, responses required repeated orientation of attention
away from the negative word in the pair. Each ABM block took approximately
15 minutes.

...
There is CBM-I, CBM-X ...

... but this is about CBM-A

The dot-probe task measures
attentional bias using differences in response times to pairs of visual
stimuli with differing affective valence, such as negative and neutral
word pairs \parencite{macleod_attentional_1986}.

Randomised controlled trials indicate that CBM may be an effective treatment
...
Meta-analysis critique of small effect sizes
...
\textcite{yang_attention_2015} met both criteria

...
on parallel distributed processing model to explain discrepancies arising
...
explains why targetting underlying goal discrepancies may provide more
...
\paragraph{Boom - cognitive mechanisms Mechanisms relatively unknown (list areas being studied)}

Proposed mechanisms include Inhibitory control \parencite{koster_understanding_2011}.
...
Of the known ones, attentional bias

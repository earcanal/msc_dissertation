...
proof-of-principle study with \todo{long-term training and ideographic
was novel, therefore suitable starting place was a case series}. Details
of the design can be found in the \nameref{analyses} section.
...
reliable and valid, having an expected Cronbach's $\alpha$ of .85
\parencite{treynor_rumination_2003}.

\subsubsection{GAD-7}

The GAD-7 is a 7 item, trait measure of Generalised Anxiety
Disorder, with item scores ranging from 0--3.  The GAD-7 is an
...
\parencite{spitzerrl_brief_2006}.
...
Attentional bias was measured using the computer-based dot-probe task

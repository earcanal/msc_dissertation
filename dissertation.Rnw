...
Fifteen participants (n female) meeting the screening criteria completed the setup session (see Table n).
...
\todo{table (see table design scribbled on printout which combines inferentials and meta analysis}
